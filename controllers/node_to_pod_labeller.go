...
//+kubebuilder:webhook:path=/mutate-v1-pod,mutating=true,failurePolicy=fail,sideEffects=None,groups=cluster.ytsaurus.tech,resources=pods,verbs=create;update,versions=v1,name=yt-pod-rack.kb.io,admissionReviewVersions=v1
